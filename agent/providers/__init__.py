...
def obtener_proveedor() -> ProveedorWhatsApp:
    ...
    if not proveedor:
        raise ValueError("WHATSAPP_PROVIDER no configurado en .env. Opciones: meta | twilio")
    ...
    if proveedor == "meta":
        ...
        raise ValueError(f"Proveedor no soportado: '{proveedor}'. Opciones válidas: meta | twilio")
